...
void initializeFonts(Font * _font, 
...
*/
void printstr(Font * ft_font, float x, float y, const char * fmt)
{
    glPushMatrix();
...
//printstr(&fonts[0], 400, 400, "howdy a jammin ttf fonts! /");
//printstr(&fonts[0], 400, 500, "stand by braces! unto tha bruuchs!");
