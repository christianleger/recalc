...
void key_in( void * in_key ) 
{
    ...
    if (c.current_char<CONSOLE_LINE_LENGTH+1)
    {
        ...
        c.current_char++ ;
        c.current_line_pix_len += fonts[0]->width[ key - upper_case ] ;
    }
...
void Console::initialize()
{
    ...
    console_commands[SDLK_LESS] = &key_in ;
    console_commands[SDLK_EQUALS] = &key_in ;
    console_commands[SDLK_PERIOD] = &key_in ;
    console_commands[SDLK_SLASH] = &key_in ;
